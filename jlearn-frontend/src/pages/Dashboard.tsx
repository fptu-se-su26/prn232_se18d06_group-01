    ...
    <div className="p-6 md:p-8 max-w-7xl mx-auto space-y-10 transition-colors duration-300">
      ...
      <section className="space-y-6">
        ...
        {communityDecks.length === 0 ? (
          <div className="text-center py-20 bg-white dark:bg-slate-800 rounded-3xl border border-dashed border-slate-350 dark:border-slate-700 shadow-sm space-y-4">
              ...
              >
                ...
                <div className="border-t border-slate-100 dark:border-slate-700/50 pt-4 flex items-center justify-between mt-4">
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 bg-slate-100 hover:bg-indigo-50 dark:bg-slate-700 dark:hover:bg-indigo-950/50 text-slate-700 hover:text-indigo-600 dark:text-slate-350 dark:hover:text-indigo-400 font-extrabold text-xs px-3.5 py-2 rounded-xl transition-all active:scale-95"
...
const StatCard = ({ icon, title, value, subtitle, color }: { icon: React.ReactNode, title: string, value: number, subtitle: string, color: string }) => (
  <div className={`bg-white dark:bg-slate-800 rounded-2xl p-6 border ${color} shadow-sm flex items-center gap-5 transition-all duration-300 hover:shadow-md`}>
    ...
    <div className="space-y-0.5">
      ...
      <p className="text-xs text-slate-500 dark:text-slate-450">{subtitle}</p>
    </div>
  </div>
);
